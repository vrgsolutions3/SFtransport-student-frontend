...
export default function ErrorPage({ error, reset }: ErrorPageProps) {
  ...
  return (
    <main className="min-h-dvh bg-mesh px-6 py-10 flex items-center justify-center">
      <section
      ...
      >
        ...
        <p className="mt-3 text-center text-on-surface-variant">
          Tivemos um problema interno ao processar sua solicitacao. Tente novamente em instantes.
        </p>
